<?php
// source: E:\xampp\htdocs\pskeleton\tests/../app/config/config.neon 
// source: E:\xampp\htdocs\pskeleton\tests/../app/config/config.local.neon 

class Container_72d1cc5b8d extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'E:\xampp\htdocs\pskeleton\tests',
			'wwwDir' => 'E:\xampp\htdocs\pskeleton\tests',
			'debugMode' => FALSE,
			'productionMode' => TRUE,
			'environment' => 'production',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'E:\xampp\htdocs\pskeleton\tests/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('E:\xampp\htdocs\pskeleton\tests/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('E:\xampp\htdocs\pskeleton\tests/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_72d1cc5b8d_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_72d1cc5b8d_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_72d1cc5b8d $container)
	{
