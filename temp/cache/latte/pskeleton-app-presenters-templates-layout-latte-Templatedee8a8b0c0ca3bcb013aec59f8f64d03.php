<?php
// source: E:\xampp\htdocs\pskeleton\app\presenters/templates/@layout.latte

class Templatedee8a8b0c0ca3bcb013aec59f8f64d03 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('9ef266fa58', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb335b3435a8_head')) { function _lb335b3435a8_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb2e1817d0ec_scripts')) { function _lb2e1817d0ec_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
