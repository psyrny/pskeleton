<?php
// source: E:\xampp\htdocs\pskeleton\app\presenters/templates/Homepage/default.latte

class Templateae832093edb276dc15d16a0cd0ca1a84 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('0df4e22cae', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbab147fb0e3_content')) { function _lbab147fb0e3_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb932febad83_title')) { function _lb932febad83_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb42ecee91e6_scripts')) { function _lb42ecee91e6_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb28bf6908e1_head')) { function _lb28bf6908e1_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
